...
public class ThutucFragment extends BaseFragment implements TheloaiView {
  ...
  private void initBottomTab() {
    NavigationController navigationController = layoutTab.material()
            .addItem(R.drawable.ic_home_black_24dp, getString(R.string.upload_tratruoc), getResources().getColor(R.color.md_teal_A700))
            .addItem(R.drawable.ic_business_black_24dp, getString(R.string.upload_trasau), getResources().getColor(R.color.md_red_500))
