...
public class UpanhTratruocFragment extends TakePhotoFragment implements UpanhView{
  ...
  public void btn_upload(){
    mUpanhPresenter.uploadTratruoc(mUpanhPresenter.getmPreferencesHelper().getJsonInfo().getPhone(),mUpanhPresenter.getmPreferencesHelper().getJsonInfo().getDichvu(),requestBody,requestBody1,requestBody2);
  }
