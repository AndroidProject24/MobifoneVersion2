...
public class TraSauDoanhnghiepFragment extends BaseFragment implements UpanhView {
  @Inject
  UpanhPresenter
  mUpanhPresenter;
  ...
  private void returnUri(int index, Uri uri){
    switch (index){
      ...
      case BitmapDef.PL4:
        ...
        break;
      case BitmapDef.GPKD:
        loadImageView(mContext,uri,imgGpkd);
        requestBody5 = UploadUtils.prepareFilePart(mContext,uri);
        break;
    }
    if(showFab())
